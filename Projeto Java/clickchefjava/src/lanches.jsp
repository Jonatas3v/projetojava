  ...
  <section id="portfolio" class="portfolio">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item lanches">
            <img src="../img/panquecabanana.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Panqueca de Banana Pequena</h4>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item lanches">
            <img src="../img/paqueca.jpeg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Panqueca de Banana Grande</h4>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item lanches">
            <img src="../img/coxinhabatatadoce.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Coxinha de Batata Doce</h4>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item lanches">
            <img src="../img/biscoitocaseiro.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Biscoito Caseiro (5 Und)</h4>
              <span class="profession">R$ 6,00</span>
              <button class="cta">
                <span>Adicionar ao carrinho</span>
                <a class="details-link" title=""><i class=""></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item lanches">
            <img src="../img/croquetecarne.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Croquete de Carne Moída</h4>
              <span class="profession">R$5,00</span>
              <button class="cta">
                <span>Adicionar ao carrinho</span>
                <a class="details-link" title=""><i class=""></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item lanches">
            <img src="../img/sanduichenatural.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Sanduíche Natural de Frango</h4>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item lanches">
            <img src="../img/sanduichenatural.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Sanduíche Natural de Queijo</h4>
              <span class="profession">R$5,00</span>
              <button class="cta">
                <span>Adicionar ao carrinho</span>
                <a class="details-link" title=""><i class=""></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item lanches">
            <img src="../img/bolowheyprotein.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Bolo Whey Protein de Baunilha</h4>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item lanches">
            <img src="../img/bolowheyprotein.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Bolo Whey Protein de Chocolate</h4>
