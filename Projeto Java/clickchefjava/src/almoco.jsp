  ...
  <section id="portfolio" class="portfolio">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item almoco ">
          <img src="../img/sufleLegumes.jpg" class="img-fluid" alt="">
          <div class="portfolio-info">
            <h4>Suflê de Legumes</h4>
            <p>Cenoura, abobrinha, chuchu, tomate, cebola e ovo</p>
            <span class="profession">R$23,99</span>
            <button class="cta">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item almoco">
          <img src="../img/frangopurebrocolis.jpg" class="img-fluid" alt="">
          <div class="portfolio-info">
            <h4>Frango com Purê e Brócolis</h4>
            <p>Frango grelhado c/ purê, brócolis, pepino, abóbora e arroz c/
              brócolis</p>
            <span class="profession">R$19,99</span>
            <button class="cta">
              <span>Adicionar ao carrinho</span>
              <a class="details-link" title=""><i class=""></i></a>
          </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item almoco">
          <img src="../img/caneloneAbobrinha.jpg" class="img-fluid" alt="">
          <div class="portfolio-info">
            <h4>Canelone de abobrinha</h4>
            <p>Abobrinha, frango c/ creme de ricota, molho de tomate e queijo
              light</p>
            <span class="profession">R$23,90</span>
            <button class="cta">
              <span>Adicionar ao carrinho</span>
              <a class="details-link" title=""><i class=""></i></a>
          </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item almoco ">
          <img src="../img/pratocarioca.jpg" class="img-fluid" alt="">
          <div class="portfolio-info">
            <h4>Prato Carioca</h4>
            <p>Arroz, feijão, ovo cozido, alface, cenoura ralada e tomate</p>
            <span class="profession">R$18,99</span>
            <button class="cta">
              <span>Adicionar ao carrinho</span>
              <a class="details-link" title=""><i class=""></i></a>
          </div>
