  ...
  <section id="portfolio" class="portfolio">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item suco">
            <img src="../img/laranja_cenoura_morango.png" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Laranja, Cenoura e Morango</h4>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item suco">
            <img src="../img/beterraba-morango-chia.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Beterraba, Morango e Chia</h4>
              <span class="profession">R$7,00</span>
              <button class="cta">
                <span>Adicionar ao carrinho</span>
                <a class="details-link" title=""><i class=""></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item suco">
            <img src="../img/detox-de-couve.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Suco Detox</h4>
              <span class="profession">R$7,00</span>
              <button class="cta">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item suco">
            <img src="../img/abacaxi-hortela.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Abacaxi, Hortelã e Gengibre</h4>
              <span class="profession">R$7,00</span>
              <button class="cta">
                <span>Adicionar ao carrinho</span>
                <a class="details-link" title=""><i class=""></i></a>
