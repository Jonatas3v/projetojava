  ...
  <section id="portfolio" class="portfolio">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item jantar">
            <img src="../img/salmaolegumes.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Filé de Peixes com Legumes</h4>
              <p>Peixe grelhado, alface, tomate, aipim e cenoura</p>
              <span class="profession">R$18,00</span>
              <button class="cta">
                <span>Adicionar ao carrinhor</span>
                <a class="details-link" title=""><i class=""></i></a>
            </div>
          </div>
  
          <div class="col-lg-4 col-md-6 portfolio-item jantar">
            <img src="../img/frangobatatadoce.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Frango com Batata Doce</h4>
              <p>Frango grelhado, purê de batata doce, alface, tomate e
                cenoura</p>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item jantar">
            <img src="../img/carnemoidaovos.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Carne Moída com Ovos</h4>
              <p>Carne moída c/ legumes, ovos cozidos, brócolis a vapor e
                tomate</p>
              <span class="profession">R$17,00</span>
              <button class="cta">
                <span>Adicionar ao carrinhor</span>
                <a class="details-link" title=""><i class=""></i></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item jantar">
            <img src="../img/brocolis-ovos.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Ovos Cozidos com Brócolis e Tomate</h4>
              <p>Ovos cozidos, brócolis a vapor e tomate</p>
              <span class="profession">R$12,00</span>
              <button class="cta">
                <span>Adicionar ao carrinho</span>
                <a class="details-link" title=""><i class=""></i></a>
            </div>
