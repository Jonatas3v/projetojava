  ...
  <section id="portfolio" class="portfolio">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item cupSalada">
            <img src="../img/cupsalada-alface-cenoura.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Alface Cenoura e Tomate</h4>
              <p>Tomate, alface, cenoura, brócolis e abobrinha</p>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item cupSalada">
            <img src="../img/elementoX.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Elemento X</h4>
              <p>Abóbora, pepino, chuchu, batata doce (chips ou salada) e
                beterraba</p>
              <span class="profession">R$5,00</span>
              <button class="cta">
                <span>Adicionar ao carrinho</span>
